...
class RewardTrainer(Trainer):
    ...
    def __init__(
        ...
        if data_collator is None:
            ...
            if args.remove_unused_columns:
                # Maintain backward compatibility before https://github.com/huggingface/transformers/pull/25435
                try:
    ...
    def prediction_step(
        ...
        # Stack accepted against rejected, calculate mean over logits,
        # and apply softmax to ensure preferences between accepted and rejected sum to 1.
